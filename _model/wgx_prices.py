...
# todo: show charts of each of the component month deltas - annotate the summary stats for each month delta for each component
# todo: start tracking a histogram of the front month settlement for WGX(this may take a while, but will only need to be done once)
# todo: build a heatmap for WGX and show historical statistics
